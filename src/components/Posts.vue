            ...
            <div class="container d-flex justify-content-between">
                ...
                <div class="icons col-2">
                    <ul class="icons-list">
                        ...
                        <li class="pb-2">
                            <a href="https://www.instagram.com/emkygsz/" class="text-dark">
                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor"
                        ...
                        <li class="pb-2">
                            <a href="https://www.linkedin.com/in/emre-kaygusuz-058426129/" class="text-dark">
                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor"
                        ...
                        <li class="pb-2">
                            <a href="https://github.com/kaygusuzemre" class="text-dark">
                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor"
                        ...
                        <li class="pb-2">
                            <a href="https://stackoverflow.com/users/13035922/wholucyinthesky" class="text-dark">
                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor"
                ...
                <div class="menu col-2">
                    <ul class="menu-list navBar ps-5">
                        ...
                        <li class="fs-5 pe-2 pb-2">
                            <router-link class="router text-decoration-none text-dark" to="/projects">Projects</router-link>
                        </li>
                        <li class="fs-5 pe-2 pb-2">
                            <router-link class="router text-decoration-none text-dark" to="/blog">Blog</router-link>
                        </li>
                        <li class="fs-5 pe-2 pb-2">
                            <router-link class="router text-decoration-none text-dark" to="/about"
                                style="">About</router-link>
                        </li>
                        <li class="fs-5 pe-2 pb-2">
